...
namespace TokenAuthentication.Service.Services
{
    public class AuthenticationService : IAuthenticationService
    {
        ...
        {
            var entityRefreshToken = await _userRefreshTokenService.Where(x => x.Code == refreshToken).SingleOrDefaultAsync();
            ...
            entityRefreshToken.Code = tokenDto.RefreshToken;
            entityRefreshToken.Expiration = tokenDto.RefreshTokenExpiration;
        ...
        public async Task<Response<NoDataDto>> RevokeRefreshToken(string refreshToken)
        {
            ...
            _userRefreshTokenService.Remove(entityRefreshToken);
            await _unitOfWork.CommitAsync();
